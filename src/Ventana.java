...
public class Ventana extends JFrame implements MouseListener, KeyListener{
	...
	public void calculadora() {
		...
		for (String btn_text : btn_texts) {
			botones.add(new JButton(btn_text));
		}
		...
		for (String actions_text : actions_texts) {
			actions.add(new JButton(actions_text));
		}
	...
	public void mouseEntered(MouseEvent e) {
        ...
        try {
        	...
        	System.out.println("Error 198724 notifique al administrador");
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode()==87) {
			...
			for (Component element : arreglo) {

				if(element.getClass().toString().equals("class javax.swing.JButton")) {

					JButton link = (JButton) element;
